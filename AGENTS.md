...
- Do not edit protected paths: `AGENTS.md`, `harness/`, `tests/harness/`, `.githooks/`, `.github/`, `pyproject.toml`, The gate enforces this; the list lives in `harness/gate.py`.
...
- Keep the doc set small: README, AGENTS, `docs/INTERFACES`, `docs/PROJECT_STATUS`, `docs/RESEARCH`, `specs/`, `PROMPT.md`, `docs/PLAN`.
